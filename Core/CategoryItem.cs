...
namespace SS.GovPublic.Core
{
    ...
    public class CategoryTreeItem
    {
        ...
        {
            var treeDirectoryUrl = Main.UtilsApi.GetAdminDirectoryUrl("assets/icons/tree/");
...
";
            ...
            script = script.Replace("{iconLoadingUrl}",Main.UtilsApi.GetAdminDirectoryUrl("assets/icons/loading.gif"));
